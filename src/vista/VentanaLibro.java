...
public class VentanaLibro extends JFrame{
    ...
    private void iniciaComponentes() {
        ...
        this.etiList.add(new JLabel("Nombre del Libro: "));
        this.etiList.add(new JLabel("Numero de Paginas: "));
        this.etiList.add(new JLabel("Genero Literario: "));
        ...
        this.datos = this.cargaDatosTabla(this.gD.getLibroList().size(),4);
        ...
        this.boton1.addActionListener(new EventoVentanaLibro(this));
        this.boton2.addActionListener(new EventoVentanaLibro(this));
        this.boton3.addActionListener(new EventoVentanaLibro(this));
    ...
    public Object[][] cargaDatosTabla(int h, int w){
        ...
        for(Libro l:this.gD.getLibroList())
        {
            ...
            retorno[i][1]=l.getNombreLibro();
            retorno[i][2]=l.getAutor().getNombre()+" "+l.getAutor().getApellido();
            retorno[i][3]=l.getGeneroLiterario();
            i++;
        }        
        return retorno;
    ...
    public Object[] cargarCombo(){
        Object[] retorno = new Object[this.gD.getAutorList().size()];
        int i=0;
        for(Autor a:this.gD.getAutorList()){
            retorno[i]=a.getApellido();
            i++;
        }
        return retorno;
    }
